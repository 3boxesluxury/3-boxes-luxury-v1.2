...
// PATCH /api/partners/[id] — Partial update for partner status and verification
export async function PATCH(
  ...
  try {
    ...
    console.error('Error patching partner:', err);
    return Response.json({ error: 'Failed to patch partner' }, { status: 500 });
  }
}
