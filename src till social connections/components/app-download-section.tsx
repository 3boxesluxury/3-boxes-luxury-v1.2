...
const benefits = [
  {
    icon: Zap,
    titleKey: 'appDownload.benefitFasterShopping',
    descKey: 'appDownload.benefitFasterShoppingDesc',
  },
  {
    icon: Sparkles,
    titleKey: 'appDownload.benefitExclusiveDeals',
    descKey: 'appDownload.benefitExclusiveDealsDesc',
  },
  {
    icon: Gift,
    titleKey: 'appDownload.benefitAIGiftAssistant',
    descKey: 'appDownload.benefitAIGiftAssistantDesc',
  },
  {
    icon: Crown,
    titleKey: 'appDownload.benefitVIPExperience',
    descKey: 'appDownload.benefitVIPExperienceDesc',
  },
  {
    icon: Shield,
    titleKey: 'appDownload.benefitSecurePayments',
    descKey: 'appDownload.benefitSecurePaymentsDesc',
  },
  {
    icon: Star,
    titleKey: 'appDownload.benefitWishlistAlerts',
    descKey: 'appDownload.benefitWishlistAlertsDesc',
  },
];
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-amber-200/60 sm:text-lg">
              {t('appDownload.whyYoullLoveDesc')}
            </p>
          </motion.div>
                ...
                {canInstall ? (
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[10px] leading-tight text-amber-200/50">{t('appDownload.installAppLabel').toUpperCase()}</div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[10px] leading-tight text-emerald-200/50">{t('appDownload.installed').toUpperCase()}</div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[10px] leading-tight text-amber-200/50">{t('appDownload.installOn').toUpperCase()}</div>
