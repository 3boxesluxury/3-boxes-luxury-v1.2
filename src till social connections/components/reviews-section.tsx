  ...
  if (!selectedProductId) {
    return (
      <div className="flex flex-col items-center justify-center py-24">
        ...
        <p className="text-amber-200/40">{t('productDetail.productNotFound')}</p>
        <Button
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-8">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {productData && (
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-amber-100">{t('productDetail.reviews')} for {productData.name}</h2>
          </div>
        )}
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-sm text-amber-200/40">
                  {t('productDetail.basedOnReview', { count: summary.totalReviews })}{summary.totalReviews !== 1 ? 's' : ''}
                </p>
                ...
                <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
                  ...
                  <DialogContent className="bg-stone-950 border-amber-900/30">
                    ...
                    <div className="space-y-4 mt-4">
                      <div>
                        <Label className="text-amber-200/60">{t('productDetail.rating')}</Label>
                        <div className="mt-2">
                          <StarRating
                            value={reviewRating}
                        ...
                        {reviewRating === 0 && reviewMutation.isError && (
                          <p className="text-xs text-red-400 mt-1">{t('productDetail.selectRating')}</p>
                        )}
                      </div>
                      <div>
                        <Label className="text-amber-200/60">{t('productDetail.titleOptional')}</Label>
                        <Input
                          value={reviewTitle}
                      ...
                      <div>
                        <Label className="text-amber-200/60">{t('productDetail.yourReview')}</Label>
                        <Textarea
                          value={reviewComment}
        ...
        {reviewsLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-amber-200/40 text-lg">{t('productDetail.noReviews')}</p>
          </div>
        ) : (
          <div className="space-y-4">
            ...
            {reviews.length > 5 && !showAll && (
              ...
              >
                {t('productDetail.showAllReviews', { count: reviews.length })}
