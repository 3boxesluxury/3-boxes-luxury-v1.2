...
export function LocaleSwitcher() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="w-80 max-h-[80vh] border-amber-900/30 bg-stone-950 p-0 shadow-xl shadow-amber-900/20 overflow-hidden flex flex-col"
        align="end"
        sideOffset={8}
      >
        {/* Tabs */}
        ...
        {/* Currency List */}
        {activeTab === 'currency' && (
          <ScrollArea className="flex-1 min-h-0 [&_[data-slot=scroll-area-thumb]]:bg-amber-600/40 [&_[data-slot=scroll-area-thumb]]:hover:bg-amber-500/60">
            <div className="py-1">
