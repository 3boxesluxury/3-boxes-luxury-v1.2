...
interface SocialFeature {
  ...
  // i18n keys (resolved at render time via t())
  titleKey: string;
...
const SOCIAL_FEATURES: SocialFeature[] = [
  {
    icon: Share2,
    titleKey: 'socialConnections.shareWishlists',
    descriptionKey: 'socialConnections.shareWishlistsDesc',
  ...
  {
    icon: Users,
    titleKey: 'socialConnections.groupGifting',
    descriptionKey: 'socialConnections.groupGiftingDesc',
  ...
  {
    icon: MessageCircle,
    titleKey: 'socialConnections.giftChat',
    descriptionKey: 'socialConnections.giftChatDesc',
  ...
  {
    icon: PartyPopper,
    titleKey: 'socialConnections.celebrationReminders',
    descriptionKey: 'socialConnections.celebrationRemindersDesc',
  ...
  {
    icon: Heart,
    titleKey: 'socialConnections.giftRegistry',
    descriptionKey: 'socialConnections.giftRegistryDesc',
  ...
  {
    icon: Award,
    titleKey: 'socialConnections.referralRewards',
    descriptionKey: 'socialConnections.referralRewardsDesc',
...
const OCCASIONS = [
  { emoji: '🎂', labelKey: 'occasions.birthday' },
  { emoji: '💑', labelKey: 'occasions.anniversary' },
  { emoji: '🏠', labelKey: 'occasions.housewarming' },
  { emoji: '🎓', labelKey: 'occasions.graduation' },
  { emoji: '👶', labelKey: 'occasions.babyShower' },
  { emoji: '🎊', labelKey: 'occasions.festivals' },
];
      ...
      <div className="relative container mx-auto px-4">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className={`mx-auto mt-2 max-w-2xl text-sm ${ctaTextClass} sm:text-base`}>
                {t('socialConnections.connectYourSocialNetworks')}
              </p>
              ...
              <div className="text-center">
                <span className="text-sm font-medium text-amber-100">
                  {hasAnyConnection
                    ...
                    : t('socialConnections.noNetworksConnected')}
                </span>
        ...
        >
          {OCCASIONS.map((occ) => (
            ...
            >
              <span>{occ.emoji}</span>
              <span className="font-medium">{t(occ.labelKey)}</span>
            </div>
          ))}
        </motion.div>
            ...
            return (
              ...
              >
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <h3 className={`text-base font-bold ${titleTextClass}`}>{t(feature.titleKey)}</h3>
                </div>
                <p className={`text-xs leading-relaxed ${descriptionTextClass}`}>{t(feature.descriptionKey)}</p>
              </motion.div>
            );
          })}
        </div>
        ...
        >
          <p className="text-xs text-amber-200/40">
            ...
            {t('socialConnections.trustedByFamilies')}
          </p>
        </motion.div>
      </div>
    </section>
